#!/usr/bin/env python3
"""
Generate visualization plots for marine acoustic detection results.
...
COLORS = {
    "Ambient": "#94a3b8",
    "Fin Whale (20 Hz)": "#00d4aa",
    "Blue Whale (80 Hz)": "#3b82f6",
    "Ship Noise (140 Hz)": "#ef4444",
    "Humpback Song (200 Hz)": "#f59e0b",
}
BG = "#0a0f1c"
CARD = "#1e293b"
TEXT = "#f1f5f9"
...
def plot_timeline(results):
    ...
    ax.set_yticks([])
    ax.set_title("Marine Acoustic Event Timeline", color=TEXT, fontsize=13, fontweight='bold')
    ...
    fig.tight_layout()
    path = DOCS_DIR / "event_timeline.png"
...
def plot_confusion(results):
    ...
    short = ["Ambient", "Fin", "Blue", "Ship", "Hump"]
    n = len(classes)
    ...
    ax.set_title("Marine Acoustic Confusion Matrix",
    ...
    for i in range(n):
        for j in range(n):
            ...
            ax.text(j, i, str(matrix[i, j]),
                    ha='center', va='center', color=c, fontsize=12, fontweight='bold')
