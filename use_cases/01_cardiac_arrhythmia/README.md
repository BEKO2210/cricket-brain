...
> "example".
>
> **Validation status:** v0.4 — first real MIT-BIH run on 5 records
> (100, 105, 200, 217, 232) — 11 375 annotation beats — **96.1 %
> pooled accuracy**, **0.79 macro-F1**, **0.94 Irregular recall** on
> AF/ectopic-rich segments. Bradycardia has zero ground-truth support
> in this 5-record subset — performance there cannot be claimed yet
> (tracked in [BENCHMARK_ROADMAP.md](BENCHMARK_ROADMAP.md) as v0.4-
> followup). Full results in
...
## Benchmark Results — v0.4 (first real MIT-BIH run)

Generated by `cardiac_mitbih` on records 100, 105, 200, 217, 232
(11 375 annotation beats total). Ground truth is the rate-regime
...
BPM. Full machine-readable output in
[`results/cardiac_mitbih_summary.json`](results/cardiac_mitbih_summary.json).
